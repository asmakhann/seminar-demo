            ...
            <div className="doctorHeading">
                <div className="doctorNav">
                    <Nav className="justify-content-end">
                        ...
                        <Nav.Item>
                            <Nav.Link className="navLink" href="/">Dental Services</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link className="navLink" href="/">Reviews</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                            <Nav.Link className="navLink" href="/">Doctors Zone</Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
            ...
            <div className="ourBlog">
                <div>
                    ...
                    <div className="ourBlogDetails">
                        <Card style={{ width: '21rem', border: "none", boxShadow: "5px 5px 10px lightGray" }}>
                            <Card.Body>
                                <p style={{ fontSize: "20px", fontWeight: "600", marginBottom: "-5px" }}> John </p>
                                <p>21 July 2022</p>
